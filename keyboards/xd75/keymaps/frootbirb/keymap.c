...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        RGUI(LCTL(KC_Q)),	KC_1,	KC_2,		KC_3,	KC_4,	KC_5,			KC_PSLS,	KC_EQUAL,	KC_PMNS,	KC_6,	KC_7,		KC_8,		KC_9,		KC_0,		RGUI(KC_F),
        ...
        xx,			KC_Z,	KC_X,		KC_C,	KC_V,	KC_B,			KC_KP_1,	KC_KP_2,	KC_KP_3,	KC_N,	KC_M,		KC_COMM,	KC_DOT,		KC_UP,		KC_LSFT,
        KC_RCMD,		KC_LALT,KC_LCTRL,	TD(CP),	KC_SPC,	MT(MOD_LSFT, KC_ENT),	MO(SYM),	KC_KP_0,	KC_BSPC,	KC_SPC,	MO(NAV),	xx,		KC_LEFT,	KC_DOWN,	KC_RGHT
	),

    KEYMAP(
        __,		__,		__,		__,		__,		__,		__,	__,	__,	__,	__,		__,		__,		__,		__,
        KC_CIRC,	KC_6,		KC_7,		KC_8,		KC_9,		KC_0,		__,	__,	__,	__,	KC_UNDS,	KC_AT,		KC_HASH,	KC_DLR,		__,
