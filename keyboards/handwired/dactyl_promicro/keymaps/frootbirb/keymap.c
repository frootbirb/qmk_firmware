...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [DEF] = LAYOUT_6x6(
		...
		KC_LSFT, KC_Z,  KC_X,  KC_C, KC_V, KC_B,   MO(NUM), xxxx,       xxxx,    TG(NUM), KC_N,   KC_M, KC_COMM, KC_DOT,  KC_UP,   KC_RSFT,
    ...
    [SYM] = LAYOUT_6x6(
		RESET, ____,    ____,    ____,    ____,    ____,                              ____,    ____,    ____,    ____,    ____,    RESET,
		...
		____,  KC_PLUS, KC_MINS, KC_ASTR, KC_BSLS, KC_EQL, ____, ____,    ____, ____, ____,    KC_CIRC, KC_PERC, ____,    ____,    ____,
    ...
    [NAV] = LAYOUT_6x6(
		...
		____,   KC_F9, KC_F10, KC_F11, KC_F12, ____, ____, TG(GAM),    TOG_OS, ____, ____,  ____,    ____,    SCRNSHT, KC_PGUP, KC_CAPS,
		MOD_4,  MOD_5, MOD_6,  ____,   ____,               ____,       ____,                ____,    ____,    KC_HOME, KC_PGDN, KC_END,
