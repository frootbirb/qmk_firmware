...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT_ortho_5x15(
        ...
        KC_LCTL, KC_LWIN, KC_LALT, COPY, KC_SPC, SFT_ENT, MO(SYM), KC_P0,  KC_BSPC, KC_SPC, MO(NAV), xxxx,    KC_LEFT, KC_DOWN, KC_RGHT
    ),
    ...
    LAYOUT_ortho_5x15( // function layer
        KC_PWR, ____,  ____,   ____,   ____,   ____, ____, ____, ____, ____, ____,    ____,    ____,    ____,    RGUI(KC_S),
