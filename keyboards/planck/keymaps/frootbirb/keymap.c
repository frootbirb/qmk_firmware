...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_UP, TD(COPY_PASTE),
		KC_LCTRL, KC_LGUI, KC_LALT, TD(COPY_PASTE), KC_SPC, LT(NUM, KC_ENT), KC_SPC, MO(NAV), OSL(SND), KC_LEFT, KC_DOWN, KC_RGHT),

	KEYMAP(
		__, KC_MINS, KC_7, KC_8, KC_9, KC_ASTR, KC_TILD, KC_UNDS, KC_AT, KC_HASH, KC_DLR, KC_DEL,
		__, KC_PLUS, KC_4, KC_5, KC_6, KC_SLSH, KC_BSLS, TD(PAREN), TD(BRACE), TD(BRACKET), TD(ANGLE_BRACKET), KC_AMPR,
		__, KC_EQL, KC_1, KC_2, KC_3, KC_GRV, KC_CIRC, KC_EXLM, KC_QUES, KC_PERC, __, TD(COPY_PASTE_ALL),
		__, __, __, KC_0, KC_DOT, __, __, __, __, __, __, __),

	KEYMAP(
		KC_PWR, KC_F1, KC_F2, KC_F3, KC_F4, __, __, LGUI(LCTL(KC_LEFT)), LGUI(LCTL(KC_D)), LGUI(LCTL(KC_F4)), LGUI(LCTL(KC_RGHT)), LGUI(KC_S),
		__, KC_F5, KC_F6, KC_F7, KC_F8, __, __, KC_INS, KC_NLCK, KC_CAPS, KC_SLCK, LGUI(KC_D),
		__, KC_F9, KC_F10, KC_F11, KC_F12, __, __, LSFT(KC_TAB), KC_TAB, KC_PSCR, KC_PGUP, __,
