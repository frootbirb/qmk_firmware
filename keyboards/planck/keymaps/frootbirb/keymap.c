...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, COPY, KC_SPC, SFT_ENT, SYM_SPC, MO(NAV), DF(MAC), KC_LEFT, KC_DOWN, KC_RGHT
    ),

    KEYMAP( // mac layer
        MAC_LCK, ____,    ____,    ____,    ____, ____, ____, ____, ____,    ____, ____, ____,
        ____,    ____,    ____,    ____,    ____, ____, ____, ____, ____,    ____, ____, ____,
        ____,    ____,    ____,    ____,    ____, ____, ____, ____, ____,    ____, ____, ____,
        KC_RCMD, KC_LALT, KC_LCTL, MACCOPY, ____, ____, ____, ____, DF(DEF), ____, ____, ____
    ),
